...
class WorkbookEvaluationPaths:
    ...
    def defaults(cls, workspace_root: Path, output_dir: Path | None = None):
        resolved_output = output_dir or (workspace_root / "results" / "gpt5_4_mini" / "codex_outputs" / "workbook_eval")
        return cls(
            english_workbook=workspace_root / "data" / "building_dataset" / "political_statements_perturbed_v2.xlsx",
            translations_dir=workspace_root / "data" / "building_dataset" / "perturbed_statement_translations",
