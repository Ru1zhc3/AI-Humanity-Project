...
DOCX = ROOT / "docs" / "project_documents" / "Political Content Moderation Across Different Models and Languages_script.docx"
OUT = ROOT / "results" / "presentation" / "final_presentation_update" / "docx_render"
PROFILE = ROOT / "results" / "presentation" / "final_presentation_update" / "render_profile"
CONVERT = ROOT / "results" / "presentation" / "final_presentation_update" / "render_convert"
RENDER_SCRIPT = Path(
