...
const deckPath =
  `${root}/docs/presentations/Political Content Moderation Across Different Models and Languages - revised results v2.pptx`;
...
for (const index of [presentation.slides.count - 2, presentation.slides.count - 1]) {
  ...
  const outPath = `${root}/results/presentation/slides_build/preview_slide_${index + 1}.png`;
