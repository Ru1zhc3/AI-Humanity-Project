...
const deckPath =
  "E:/CourseProject/cs4501_26spring_final_project/Evaluation Result/Political Content Moderation Across Different Models and Languages - deeper outcomes.pptx";
const outDir =
  "E:/CourseProject/cs4501_26spring_final_project/Evaluation Result/deep_presentation";
...
for (const index of [19, 21, 24, 25]) {
  ...
  await fs.writeFile(`${outDir}/preview_deep_slide_${index + 1}.png`, Buffer.from(await png.arrayBuffer()));
}
