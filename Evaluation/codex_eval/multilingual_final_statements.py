...
class MultilingualFinalStatementsPaths:
    ...
    def defaults(cls, workspace_root: Path, output_dir: Path | None = None):
        resolved_output = output_dir or (workspace_root / "Evaluation" / "codex_outputs" / "final_statements_multilingual")
        return cls(
            workbook_path=workspace_root / "Building Dataset" / "final_statements.xlsx",
